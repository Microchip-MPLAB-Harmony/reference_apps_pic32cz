...
/*******************************************************************************
  ...
  Description:
    ...
    "APP_SCREEN3_SETLIMIT_Initialize" and "APP_SCREEN3_SETLIMIT_Tasks" prototypes) and some of them are only used
    internally by the application (such as the "APP_SCREEN3_SETLIMIT_STATES" definition).  Both
...
typedef enum
{
    ...
    APP_SCREEN3_SETLIMIT_STATE_INIT=0,
    APP_SCREEN3_SETLIMIT_STATE_SERVICE_TASKS,
    /* TODO: Define states used by the application state machine. */

} APP_SCREEN3_SETLIMIT_STATES;
...
typedef struct
{
    ...
    APP_SCREEN3_SETLIMIT_STATES state;

    /* TODO: Define any additional data used by the application. */

} APP_SCREEN3_SETLIMIT_DATA;
...
/*******************************************************************************
  Function:
    void APP_SCREEN3_SETLIMIT_Initialize ( void )
  ...
  Description:
    ...
    APP_SCREEN3_SETLIMIT_Tasks function can be called.
  ...
  Example:
    <code>
    APP_SCREEN3_SETLIMIT_Initialize();
    </code>
...
/*******************************************************************************
  Function:
    void APP_SCREEN3_SETLIMIT_Tasks ( void )
