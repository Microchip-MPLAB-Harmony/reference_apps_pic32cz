...
/*******************************************************************************
  ...
  Description:
    ...
    "APP_SCREEN2_MONITOR_Initialize" and "APP_SCREEN2_MONITOR_Tasks" prototypes) and some of them are only used
    internally by the application (such as the "APP_SCREEN2_MONITOR_STATES" definition).  Both
...
typedef enum
{
    ...
    APP_SCREEN2_MONITOR_STATE_INIT=0,
    APP_SCREEN2_MONITOR_STATE_SERVICE_TASKS,
    /* TODO: Define states used by the application state machine. */

} APP_SCREEN2_MONITOR_STATES;
...
typedef struct
{
    ...
    APP_SCREEN2_MONITOR_STATES state;

    /* TODO: Define any additional data used by the application. */

} APP_SCREEN2_MONITOR_DATA;
...
/*******************************************************************************
  Function:
    void APP_SCREEN2_MONITOR_Initialize ( void )
  ...
  Description:
    ...
    APP_SCREEN2_MONITOR_Tasks function can be called.
  ...
  Example:
    <code>
    APP_SCREEN2_MONITOR_Initialize();
    </code>
...
/*******************************************************************************
  Function:
    void APP_SCREEN2_MONITOR_Tasks ( void )
