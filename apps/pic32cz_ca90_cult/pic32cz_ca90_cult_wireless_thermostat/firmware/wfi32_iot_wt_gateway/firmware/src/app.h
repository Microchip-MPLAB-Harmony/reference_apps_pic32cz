...
typedef enum
{
    ...
    APP_STATE_INIT=0,
    APP_STATE_WAIT_READ_TASK,
    APP_STATE_PUBLISH_SERVICE_TASK,   
    APP_STATE_WAIT,
    APP_STATE_ERROR
...
typedef struct
{
    ...
    SYS_CONSOLE_HANDLE consoleHandle;/* TODO: Define any additional data used by the application. */
