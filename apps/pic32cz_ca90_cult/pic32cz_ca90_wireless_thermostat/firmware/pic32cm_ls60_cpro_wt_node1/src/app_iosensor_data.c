...
/*******************************************************************************
  ...
  Summary:
    This file contains the source code for the MPLAB Harmony application for IO
    sensor temperature monitoring.

  Description:
    This file contains the source code for the MPLAB Harmony application.  It
    implements the logic of the application's IO sensor state machine and it may call
